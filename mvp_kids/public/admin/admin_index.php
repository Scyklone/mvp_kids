    ...
    <div id="main_body">
        <div id="main">
            ...
            <div id="mat_container">
                ...
                <h3>Matriculados</h3>
                <table>
                <?php $m_query = "SELECT * FROM matricula WHERE `status` = 'complete'"; 
      ...
      if(mysqli_num_rows($Mq) == 0){
          ...
          while($row = mysqli_fetch_array($Mq)){
                ...
                print "<tr>
                       ...
                       <td>  Status de Matricula: <b style='color:lightblue'>".$row['status']."</b></td>
                       </tr>
                       <br>
                       ";
                $count += 1;
...
?>
                ...
                <br><br>    
                <table>
                    <tr>Matriculados: <b style='color:white'><?php echo $count;?></b></tr>
                </table>
                <?php }
                    else{
