    ...
    <div id="main_body">
        ...
        <h3 style="font-family: 'Saira Semi Condensed', sans-serif;"></h3>
            <div id="mat_container">
                ...
                <table>
                <tr><td><h3>Nombre: </h3><td><input style="padding:6px" type="text" name="name" placeholder="name" required></td></tr>
                <tr><td><h3>Apellido Paterno: </h3></td><td><input style="padding:6px" type="text" name="apellido_p" placeholder="age" required></td></tr>
                <tr><td><h3>Apellido Materno: </h3></td><td><input style="padding:6px" type="text" name="apellido_m" placeholder="age" required></td></tr>
			    <tr><td><h3>Grado: </h3></td><td><input style="padding:6px" type="text" name="grade" placeholder="grade" required></td></tr>
                <tr><td><h3>Edad: </h3></td><td><input style="padding:6px" type="text" name="age" placeholder="7-12" required></td></tr>
			    <tr><td><h3>Escuela: </h3></td><td><input style="padding:6px" type="text" name="school" placeholder="Escuela" required></td></tr>
                <tr><td><h3>Generó: </h3></td><td><input style="padding:6px" type="text" name="gender" placeholder="M-F" required></td></tr>
                <tr><td><h3>Fecha de Nacimiento: </h3></td><td><input style="padding:6px" type="text" name="birth_date" placeholder="01/01/2015" required></td></tr>
                <tr><td><h3>Age: </h3></td><td><input style="padding:6px" type="text" name="username" placeholder="age" required></td></tr>
                </table> 
                <table>
                <tr><td><h2 style="color:black">Informacion de Padres o Encargado</h2></td></tr>
                </table>  
                <table>  
                <tr><td><h3>Nombre de Padre ó Encargado: </h3><td><input style="padding:6px" type="text" name="P_name" placeholder="nombre" required></td></tr>
                <tr><td><h3>Grado escolaridad de padre: </h3><td><input style="padding:6px" type="text" name="P_degree" placeholder="Grado Asociado" required></td></tr>
                <tr><td><h3>Nombre de Madre ó Encargada: </h3><td><input style="padding:6px" type="text" name="M_name" placeholder="nombre"></td></tr>
                <tr><td><h3>Grado escolaridad de madre: </h3><td><input style="padding:6px" type="text" name="M_degree" placeholder="Grado Asociado"></td></tr>
                </table>
                <table> 
                <h2 style="color:black">Informacion Adicional</h2>
                ...
                <tr><td><h3>Telélfono de Contacto: </h3></td>
                <td><input style="padding:6px" type="text" name="tel" placeholder="787-000-0000" required></td></tr>
                <tr><td><h3>Plan Médico: </h3></td>
                <td><input style="padding:6px" type="file" name="gender" required></td></tr>
                <tr><td><h3>Padecimiento de enfermedad: </h3></td>
                <td><textarea style="padding-left:5px; padding-top:3px; margin-top:15px" 
                name="emg_tel" placeholder="text" cols="20" rows="1" required></textarea></td></tr>
                </table>
                <input class="button_sub" style="margin-left:10px" type="submit" name="login" value="Procesar">
                <a href='matricula_official.php' class='b1'>Next</a>
                </form>
                <?php }
                    if(isset($_SESSION['admin'])){
