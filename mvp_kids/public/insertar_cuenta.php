...
<body>
    ...
    if (isset($_GET['login']))
    {
        ...
        if(mysqli_num_rows($Sq) > 0){
            ...
            if($pass==$c_pass){
            $u_query = "INSERT INTO user (username, email, pass, tel, dir_fisica, postal)
                VALUES ('$u','$email', '$pass','$tel', '$d_f', '$postal')";
              //echo "<p>$query</p>";
    ...
    ?>
                ...
                placeholder="customer_1" required></h3></td></tr>
                ...
                placeholder="Street" ></h3></td></tr>
                <tr><td><h3>Postal </td><td><h3><input style="padding:6px" type="text" name="postal" 
                placeholder="---------" ></h3></td></tr>
                </table>
                    
                <input class="button_sub" style="margin-left:10px" type="submit" name="login" value="Enter"><br>
                </form>
            </div>
        </div>
